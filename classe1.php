    ...
    <section class="dark:bg-gray-800">
        <div class="container px-6 py-10 mx-auto">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-semibold capitalize lg:text-3xl text-green-600">anciens et nouveaux élèves par classe</h1>
            </div>
            ...
            ?>
                ...
                <div class="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
                  <!--  <div class="w-full h-64 bg-gray-300 bg-center bg-cover rounded-lg shadow-md" style="background-image: url('<?php echo $row['cover'];?>');"></div>--> <br><br>
                    ...
                    <div class="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
                        ...
                        <div class="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700">
                            <form action="listeeleve.php" method="post">
                                ...
                                <button type="submit" class="px-1 py-3 text-50 font-semibold text-white uppercase transition-colors duration-300 transform bg-gray-800 rounded hover:bg-[#964B00] dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none">
                                    Liste des anciens et nouveaux élèves
                                </button>
                            </form>
                        </div>
                    </div>
