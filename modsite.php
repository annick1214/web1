        ...
        <!-- Sidebar -->
            ...
            ?>
                        ...
                        <a href="index1.php" class="flex items-center text-gray-600 -px-2 dark:text-gray-200 hover:underline">
                            ...
                            <span class="mx-2">Classe disponible</span>
            ...
            <div class="px-8 py-8">
                <form class="w-full max-w-md" method="POST" action="" enctype="multipart/form-data">               
                    <h1 class="mt-1 text-center text-gray-500 dark:text-gray-400 pb-5">Nouveau nom  <span class="text-green-400 font-bold" ><?php echo $rsite['nomSite'];?></span> </h1>
